...
export const mockMediaList = [
  {
    id: "media-1",
    name: "getting-started-with-hiway.mp4",
    thumbnail: "/images/thumbnail.jpg",
    cfThumbnail: null,
    metadata: {
      title: "Getting Started with Hiway",
    ...
    source: { duration: 1847, size: 524288000 },
  ...
  },
  {
    ...
    metadata: {
      ...
      description: "Take your content to the next level with professional editing tips",
      contentType: "Education",
    },
    source: { duration: 2456, size: 892134400 },
    status: MediaStatus.READY,
    totalViews: 3890,
  ...
  {
    id: "media-3",
    name: "monetization-guide.mp4",
    thumbnail: "/images/thumbnail.jpg",
    cfThumbnail: null,
    metadata: {
      title: "Monetization Masterclass",
      description: "Complete guide to earning from your content",
      contentType: "Business",
    },
    source: { duration: 3612, size: 1258291200 },
    status: MediaStatus.READY,
    totalViews: 2750,
  ...
  {
    id: "media-4",
    name: "audience-building-secrets.mp4",
    thumbnail: "/images/thumbnail.jpg",
    cfThumbnail: null,
    metadata: {
      title: "Audience Building Secrets",
      description: "Proven strategies to grow your subscriber base",
      contentType: "Marketing",
    },
    source: { duration: 2134, size: 734003200 },
    status: MediaStatus.READY,
    totalViews: 4210,
  ...
  {
    id: "media-5",
    name: "live-streaming-101.mp4",
    thumbnail: "/images/thumbnail.jpg",
    cfThumbnail: null,
    metadata: {
      title: "Live Streaming 101",
      description: "Everything you need to know about going live",
      contentType: "Tutorial",
    },
    source: { duration: 1523, size: 456340480 },
    status: MediaStatus.READY,
    totalViews: 1890,
  ...
  {
    id: "media-6",
    name: "content-strategy-blueprint.mp4",
    thumbnail: "/images/thumbnail.jpg",
    cfThumbnail: null,
    metadata: {
      title: "Content Strategy Blueprint",
      description: "Plan your content calendar like a pro",
      contentType: "Business",
    },
    source: { duration: 2789, size: 943718400 },
    status: MediaStatus.READY,
    totalViews: 3120,
  ...
  {
    id: "media-7",
    name: "documentary-short.mp4",
    thumbnail: "/images/thumbnail.jpg",
    cfThumbnail: null,
    metadata: {
      title: "Behind the Scenes: Creator Life",
      description: "A day in the life of a full-time content creator",
      contentType: "Documentary",
    },
    source: { duration: 1245, size: 367001600 },
    status: MediaStatus.READY,
    totalViews: 6780,
  ...
  {
    id: "media-8",
    name: "interview-series-ep1.mp4",
    thumbnail: "/images/thumbnail.jpg",
    cfThumbnail: null,
    metadata: {
      title: "Creator Interviews: Episode 1",
      description: "Exclusive interview with top creators in the industry",
      contentType: "Interview",
    },
    source: { duration: 3456, size: 1153433600 },
    status: MediaStatus.READY,
    totalViews: 2340,
  ...
  {
    id: "media-9",
    name: "equipment-review.mp4",
    thumbnail: "/images/thumbnail.jpg",
    cfThumbnail: null,
    metadata: {
      title: "Best Equipment for Creators 2024",
      description: "Complete review of cameras, mics, and lighting",
      contentType: "Review",
    },
    source: { duration: 1876, size: 628097024 },
    status: MediaStatus.READY,
    totalViews: 4560,
